    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int selectedPriority = mPriorityRadioGroup.getCheckedRadioButtonId();
                Priority priority = selectedPriority == R.id.lowPriority ? Priority.LOW : selectedPriority == R.id.medPriority ? Priority.MED : Priority.HIGH;

                int selectedStatus = mStatusRadioGroup.getCheckedRadioButtonId();
                Status status = selectedStatus == R.id.statusDone ? Status.DONE : Status.NOTDONE;
